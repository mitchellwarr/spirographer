...
!Array.prototype.sum && Object.defineProperty(Array.prototype, 'sum', {
  ...
  value: function (fn = x => x) {
    let arr = [...this];
    return arr.reduce((sum, next, i, arr) => {
...
!Array.prototype.pluck && Object.defineProperty(Array.prototype, 'pluck', {
  enumerable: false,
  value: function (...fields) {
    ...
    return arr.map(obj => {
      ...
      return fields.reduce((obj, field) => obj == null ? void 0 : obj[field], obj);
    });
  }
});
!Array.prototype.object && Object.defineProperty(Array.prototype, 'object', {
  enumerable: false,
  value: function (fn = x => x) {
    let arr = [...this];
...
const useAPICallback = (...args) => {
  const [keyMap = () => {}, func, deps] = overloadArgs(...args);
  const isCurrent = react.exports.useRef({});
...
const useStateReducer = (init = {}, {
  onChange
} = {}) => {
  const [state, setState] = react.exports.useState(init);
  const setStateWrapper = react.exports.useCallback((changes, options = {}) => {
    const {
      replace
    } = options;
    setState(state => {
...
const useUpdatingElementRef = init => {
  const [{
    ref
  }, setRef] = react.exports.useState(() => ({
    ref: {
      current: init
    }
  }));
  const setRefWrapper = react.exports.useCallback(current => {
    setRef(({
      ref
    }) => {
      ref.current = current;
...
const useMeasure = props => {
  ...
  const [bounds, setBounds] = react.exports.useState(() => ({
    left: 0,
    top: 0,
    width: 0,
    height: 0
  }));
  const set = react.exports.useCallback(obj => setBounds(oldState => {
    let bbox;
  ...
  const [ro] = react.exports.useState(() => new ResizeObserver(([entry]) => void set(entry.target)));
  react.exports.useEffect(() => {
    if (fixed) return;
...
var WorkerFactory = createBase64WorkerFactory('', null, false);
/* eslint-enable */
...
const generateLineChunks = (props, cb) => {
  ...
  const lineDataChunk = wrap(new WorkerFactory());
...
const PIES_NEEDED = (scaleData, max) => {
  ...
  for (let i = 1; i < max; i++) {
    ...
    if (Math.abs(x - start.x) < 0.1 && Math.abs(y - start.y) < 0.1) return i;
  }
...
const GraphDisplay = props => {
  ...
  const [lines, setLines] = react.exports.useState(() => []);
  useAPIEffect(async api => {
    const chunkPerPie = 4;
    const chunkLength = Math.PI * 100 / chunkPerPie;
    const piesNeeded = PIES_NEEDED({
      R,
      k,
      k2,
      h,
  ...
  const viewRadius = react.exports.useMemo(() => {
    const xDomain = extent(lines.flat(), xGetter$1);
    const yDomain = extent(lines.flat(), yGetter$1);
...
const VariableSettings = props => {
  ...
  const {
    ...
    onHChange: h => onChange({
      h
    }),
    onPChange: p => onChange({
      p
    }),
    onKChange: k => onChange({
      k
    }),
    onK2Change: k2 => onChange({
      k2
    }),
    onDeltaChange: delta => onChange({
      delta
    })
  }), [onChange]);
  return /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
...
ReactDom.render( /*#__PURE__*/jsxRuntime.exports.jsx(App, {}), document.getElementById('root'));
